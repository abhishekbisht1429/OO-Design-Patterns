...
class Person {
	...
	/*Builder bascially seperates object representation from its construction process */
...
class BuilderPatternDemo {
	public static void main(String[] args) {
		/* The line below will give error if the comment is removed
		   as the default constructor has been made private */
		//Person person = new Person();
